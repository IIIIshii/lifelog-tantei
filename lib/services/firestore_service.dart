...
class FirestoreService {
  ...
  // 日付は固定せず、今日を基準に「6日前〜今日」へ動的に割り当てるため、
  // 直近エントリ表示やAI分析（直近N日参照）にも必ずデモデータが反映される。
  Future<void> seedMockData(String uid) async {
    // 古い順（6日前→今日）に並べたエントリ列。doc IDは投入時に動的生成する。
    ...
    // entries[0] が6日前、entries[last] が今日になるよう日付を割り当てる
